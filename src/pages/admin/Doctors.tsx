    ...
    return (
        <div className="page-shell">
            <section className="page-header">
                <div><span className="page-kicker">Direktori dokter</span><h1 className="page-title">Manajemen Dokter</h1><p className="page-subtitle">Kelola nama dokter dan poliklinik agar jadwal publik dan template HUMAS selalu sinkron.</p></div>
